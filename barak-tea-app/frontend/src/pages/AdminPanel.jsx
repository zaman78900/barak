    ...
    <div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:22}}>
          ...
          <Input label="Sourcing Origin Location" value={form.originCity} onChange={e=>setForm({...form,originCity:e.target.value})}/>
        </div>
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:22}}>
          ...
          <Input label="Free Shipping Threshold (₹)" value={form.freeShippingMin} onChange={e=>setForm({...form,freeShippingMin:e.target.value})} type="number"/>
          <Select label="Store Status" value={form.storeStatus} onChange={e=>setForm({...form,storeStatus:e.target.value})} options={statusOptions}/>
        </div>
